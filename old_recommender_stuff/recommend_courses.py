...
def main():
    ...
    # Get recommendations based on the math courses from the sample
    print("\nRecommendations based on just 01017:")
    single_recs = recommender.recommend_courses(['01001'], n_recommendations=5)
    recommender.display_recommendations(single_recs)

    # You can also try multi course recommendations
    print("\nGetting recommendations for math courses 01017 and 01020:")
    recommendations = recommender.recommend_courses(['01017', '01020'], n_recommendations=3)
    recommender.display_recommendations(recommendations, show_description=False)
