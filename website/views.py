...
from website.context_dicts import course_lists, dicts_to_display, data, current_args
...
def home():
    ...
    return render_template("home.html", course_lists=course_lists(), dicts_to_display=dicts_to_display(), data = data(), args = args_dct)
